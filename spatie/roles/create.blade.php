            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0"> إضافة صلاحية </h4>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-danger">
                      <strong>معذرة!</strong> هناك مشكلة في إدخال البيانات !.<br><br>
                      <ul>
                         @foreach ($errors->all() as $error)
                           <li>{{ $error }}</li>
                         @endforeach
                  ...
                  <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                          <div class="form-group">
                              ...
                              {!! Form::text('name', null, array('placeholder' => 'مشرف، محاسب، مراجع، مضيف مواد، مضيف كورسات، ....','class' => 'form-control')) !!}
                          </div>
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-12">
                          <div class="form-group">
