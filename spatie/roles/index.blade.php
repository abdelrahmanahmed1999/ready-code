...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            @can('إضافة صلاحية')
            <a class="btn ripple btn-info" href="roles/create">إضافة صلاحية +</a>
            @endcan
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <p class="tx-12 tx-gray-500 mb-2">الخاصة بموقع {{ $setting->name }} </p>
                    @if ($errors->any())
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $role->name }}</td>
                                    <td>
                                        <a class="btn btn-info" href="{{ route('roles.show',$role->id) }}">ظهور</a>
                                        @can('تعديل صلاحية')
